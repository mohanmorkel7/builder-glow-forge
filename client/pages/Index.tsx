...
const features = [
  {
    ...
    description:
      "Complete mind, body, and spirit healing through integrated wellness practices.",
    icon: Heart,
  ...
  },
  {
    ...
    description:
      "Guided meditation sessions to center your thoughts and find inner peace.",
    icon: Brain,
  ...
  },
  {
    ...
    description:
      "Harness the power of nature with organic treatments and therapies.",
    icon: Leaf,
    color: "text-sage-600",
  },
  {
    ...
    description:
      "Revitalize your energy through specialized healing techniques and practices.",
    icon: Zap,
    color: "text-sand-600",
  },
];
...
const testimonials = [
  {
    ...
    content:
      "Aura Oasis transformed my approach to self-care. The meditation sessions are life-changing.",
    rating: 5,
  },
  {
    ...
    content:
      "Finally found a place where I can truly disconnect and recharge. Highly recommend!",
    rating: 5,
  },
  {
    name: "Emma Thompson",
    ...
    content:
      "The holistic approach here is incredible. Every session leaves me feeling renewed.",
    rating: 5,
  },
];
  ...
  return (
    <div className="relative">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-wellness-50 via-background to-ocean-50 pt-14 pb-20 sm:pb-24 lg:pb-32">
        <div
          className={
            'absolute inset-0 bg-[url(\'data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23a7f3d0" fill-opacity="0.1"%3E%3Ccircle cx="30" cy="30" r="4"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E\')] opacity-20'
          }
        />
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-8 flex justify-center">
              <Badge
                variant="secondary"
                className="px-4 py-2 text-sm bg-wellness-100 text-wellness-800 border-wellness-200"
              >
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground sm:text-xl lg:text-2xl max-w-3xl mx-auto">
              Discover a harmonious blend of ancient wisdom and modern wellness
              practices. Transform your mind, body, and spirit in our serene
              oasis of healing and renewal.
            </p>

            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Button
                size="lg"
                className="bg-gradient-to-r from-primary to-wellness-600 hover:from-primary/90 hover:to-wellness-600/90 text-lg px-8 py-4"
              >
                Book Your Session
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Experience transformative wellness through our carefully curated
              programs designed to nurture every aspect of your being.
            </p>
          </div>
              ...
              {features.map((feature, index) => (
                ...
                >
                  <CardHeader className="text-center pb-4">
                    <div
                      className={`mx-auto w-16 h-16 rounded-2xl bg-gradient-to-br from-muted to-muted/50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                    >
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-white/90">
              ...
              your personalized wellness consultation today.
            </p>
